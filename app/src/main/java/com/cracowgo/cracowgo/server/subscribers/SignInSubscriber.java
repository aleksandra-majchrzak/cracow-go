...
public class SignInSubscriber extends Subscriber<Response<ResponseBody>> {

    private User mUser;
    private SignInSubscriberListener mListener;

    public SignInSubscriber(User user, SignInSubscriberListener listener) {
        this.mUser = user;
    ...
    public void onNext(Response<ResponseBody> response) {
        ...
        if (response.errorBody() == null) {
            ...
            mListener.onSignInCompleted(regResponse);
        } else {
